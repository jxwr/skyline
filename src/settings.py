...
SKYLINE_HOME = '/home/arch/opt/skyline'

# The path for the Redis unix socket
REDIS_SOCKET_PATH = SKYLINE_HOME + '/var/tmp/redis.sock'

# The Skyline logs directory. Do not include a trailing slash.
LOG_PATH = SKYLINE_HOME + '/var/log/skyline'

# The Skyline pids directory. Do not include a trailing slash.
PID_PATH = SKYLINE_HOME + '/var/run/skyline'
...
GRAPHITE_HOST = 'http://yf-arch-test00.yf01.baidu.com:8080'

# Add by jiaoxiang, send skyline metrics to graphite, otherwise skyline 
# will use GRAPHITE_HOST as carbon host which is the webapp address.
...
OCULUS_HOST = 'http://127.0.0.1:8569'
